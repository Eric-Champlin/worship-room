...
- Reference existing components by name when the feature should reuse them (e.g., "use the existing PageHero component" or "use the same auth modal pattern as Prayer Wall")
