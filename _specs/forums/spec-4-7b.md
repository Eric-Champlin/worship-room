# Forums Wave: Spec 4.7b — Ways to Help MVP

**Master Plan Reference:** `_forums_master_plan/round3-master-plan.md` → Spec 4.7b (`round3-phase04-spec07b-ways-to-help`)
**Brief:** `_plans/forums/spec-4-7b-brief.md` (source of truth — see Section 1 of the brief: where master plan body and brief diverge, the brief wins)
**Branch:** `forums-wave-continued` (long-lived working branch — Eric handles all git operations manually; CC must NOT run any git mutations per Section 1 of the brief)
**Date:** 2026-05-10
...
- `/prayer-wall` (composer surface — WaysToHelpPicker integration into prayer_request InlineComposer; ABSENT for testimony, question, discussion, encouragement composers)
