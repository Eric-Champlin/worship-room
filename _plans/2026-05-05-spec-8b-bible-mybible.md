...
|------|-------|--------|-----------------|----------------------|
| 1 | Pre-execution recon verification + baseline capture | [NOT STARTED] | | |
| 2 | BookmarkCard placeholder de-italicize | [NOT STARTED] | | |
| 3 | bg-primary CTA migrations (Bookmark/Settings/Filter/Search) | [NOT STARTED] | | |
| 4 | MyBiblePage atmospheric + auth + banner + stat cards + hero | [NOT STARTED] | | |
| 5 | BibleReader chapter-mount effect (recordChapterVisit + markChapterRead) | [NOT STARTED] | | |
| 6 | useBibleProgress reactive store conversion | [NOT STARTED] | | |
| 7 | useActivityFeed journal subscription | [NOT STARTED] | | |
| 8 | HighlightCard brittle subscription refactor | [NOT STARTED] | | |
| 9 | HighlightCardMemorize BB-45 test rewrite | [NOT STARTED] | | |
| 10 | MemorizationFlipCard chrome + a11y | [NOT STARTED] | | |
| 11 | Final regression sweep + acceptance verification | [NOT STARTED] | | |
