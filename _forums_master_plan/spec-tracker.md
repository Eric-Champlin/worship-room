...
> - **Frontend test baseline drift** (15 fails across `GrowthGarden.test.tsx` ×8, `GrowthGarden-transition.test.tsx` ×5, `GrowthGarden-a11y.test.tsx` ×1, `warm-empty-states.test.tsx` ×1, `PrayCeremony.test.tsx` ×1) — investigation results filed 2026-05-15; not introduced by 6.6 / 6.6b / 6.7 / 6.8 / deferred-2. Future cleanup spec.
