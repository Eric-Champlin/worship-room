...
describe('ACTIVITY_POINTS', () => {
  it('has correct values for all 9 activity types', () => {
...
describe('MAX_DAILY_POINTS', () => {
  it('equals MAX_DAILY_BASE_POINTS × 2x multiplier', () => {
    ...
    expect(MAX_DAILY_POINTS).toBe(230);
  });
});

describe('ALL_ACTIVITY_TYPES', () => {
  it('contains all 9 activity types', () => {
    expect(ALL_ACTIVITY_TYPES).toHaveLength(9);
...
describe('ACTIVITY_DISPLAY_NAMES', () => {
  it('has display names for all 9 types', () => {
    expect(Object.keys(ACTIVITY_DISPLAY_NAMES)).toHaveLength(9);
...
describe('ACTIVITY_CHECKLIST_NAMES', () => {
  it('has all 9 activity types', () => {
    expect(Object.keys(ACTIVITY_CHECKLIST_NAMES)).toHaveLength(9);
