...
describe('ACTIVITY_POINTS', () => {
  it('has correct values for all 10 activity types', () => {
...
describe('MAX_DAILY_POINTS', () => {
  it('equals MAX_DAILY_BASE_POINTS × 2x multiplier', () => {
    ...
    expect(MAX_DAILY_POINTS).toBe(270);
  });
});

describe('ALL_ACTIVITY_TYPES', () => {
  it('contains all 10 activity types', () => {
    expect(ALL_ACTIVITY_TYPES).toHaveLength(10);
...
describe('ACTIVITY_DISPLAY_NAMES', () => {
  it('has display names for all 10 types', () => {
    expect(Object.keys(ACTIVITY_DISPLAY_NAMES)).toHaveLength(10);
...
describe('ACTIVITY_CHECKLIST_NAMES', () => {
  it('has all 10 activity types', () => {
    expect(Object.keys(ACTIVITY_CHECKLIST_NAMES)).toHaveLength(10);
