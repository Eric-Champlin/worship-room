...
const DAILY_SONGS: DailySong[] = [
  ...
  { id: 'song-16', trackId: '5uFsV4e4yN6OT0FJwEJbca', title: 'Graves Into Gardens', artist: 'Elevation Worship, Brandon Lake', verse: 'Isaiah 61:3 — to give them a garland for ashes, the oil of joy for mourning.' },
  ...
  { id: 'song-18', trackId: '2bOsF8M3mIVvJz0Hxbp8Yn', title: 'King of Kings', artist: 'Hillsong Worship', verse: 'Revelation 19:16 — He has on his garment and on his thigh a name written, "King of Kings and Lord of Lords."' },
  { id: 'song-19', trackId: '2JXkLh0w4PEOj0pIAHqbkE', title: 'Who You Say I Am', artist: 'Hillsong Worship', verse: 'Galatians 3:26 — For you are all children of God, through faith in Christ Jesus.' },
  { id: 'song-20', trackId: '7fcfNP7DJEF6e61BFHSN3X', title: 'Build My Life', artist: 'Housefires, Pat Barrett', verse: 'Matthew 7:24 — Everyone who hears these words of mine and does them, I will liken him to a wise man who built his house on a rock.' },
  { id: 'song-21', trackId: '0rmGAIH9LNJewFw7FKQQO0', title: 'Way Maker', artist: 'Sinach', verse: 'Isaiah 43:19 — Behold, I will do a new thing. It springs out now. Don\'t you know it?' },
  { id: 'song-22', trackId: '0aB0vFCTd3IR3hOMNoaH0X', title: 'What A Beautiful Name', artist: 'Hillsong Worship', verse: 'Philippians 2:9 — Therefore God also highly exalted him, and gave to him the name which is above every name.' },
  { id: 'song-23', trackId: '6r60lFSGs2Hwt7Wquhqwhi', title: 'Great Are You Lord', artist: 'All Sons & Daughters', verse: 'Psalm 145:3 — Great is Yahweh, and greatly to be praised. His greatness is unsearchable.' },
  { id: 'song-24', trackId: '3gbZGIVjhGYQb2IIJClFRa', title: 'Tremble', artist: 'Mosaic MSC', verse: 'Psalm 68:1 — Let God arise! Let his enemies be scattered!' },
  { id: 'song-25', trackId: '40a4Gy3MMCzQDWALADy3oi', title: 'Do It Again', artist: 'Elevation Worship', verse: 'Lamentations 3:22-23 — It is because of the loving kindnesses of Yahweh that we are not consumed... They are new every morning.' },
  { id: 'song-26', trackId: '1xSENpC5fxAuwXbuEB2mOD', title: 'Raise A Hallelujah', artist: 'Bethel Music, Jonathan David Helser', verse: 'Psalm 149:6 — May the high praises of God be in their mouths.' },
  { id: 'song-27', trackId: '6BsBctMZadPUuBjfZEH9PX', title: 'Living Hope', artist: 'Phil Wickham', verse: '1 Peter 1:3 — who according to his great mercy caused us to be born again to a living hope through the resurrection of Jesus Christ from the dead.' },
  { id: 'song-28', trackId: '33wNud0CtSgOGjJmQXwukr', title: 'Another In The Fire', artist: 'Hillsong UNITED', verse: 'Daniel 3:25 — He answered, "Look, I see four men loose, walking in the middle of the fire, and they are not hurt."' },
  { id: 'song-29', trackId: '71DorgVyClYBwqvBCmjVLd', title: 'Surrounded (Fight My Battles)', artist: 'UPPERROOM', verse: '2 Chronicles 20:22 — When they began to sing and to praise, Yahweh set ambushers against the children of Ammon.' },
  { id: 'song-30', trackId: '2R1Fbb0Y6LMhIDZVcVJfeb', title: 'Jireh', artist: 'Maverick City Music, Elevation Worship', verse: 'Genesis 22:14 — Abraham called the name of that place "Yahweh Will Provide."' },
]
