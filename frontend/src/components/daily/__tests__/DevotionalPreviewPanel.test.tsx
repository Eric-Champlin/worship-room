...
describe('DevotionalPreviewPanel', () => {
  it('renders collapsed pill with icon, label, title, and reference', () => {
    render(<DevotionalPreviewPanel snapshot={mockSnapshot} />)
  ...
  it('chevron rotates on expand', async () => {
    const user = userEvent.setup()
    const { container } = render(<DevotionalPreviewPanel snapshot={mockSnapshot} />)
  ...
  it('title truncates with long text', () => {
    ...
    render(<DevotionalPreviewPanel snapshot={longSnapshot} />)
