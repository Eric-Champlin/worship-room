          ...
          {DURATION_FILTER_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'min-h-[44px] rounded-full px-4 py-2 text-sm font-medium transition-[colors,transform] duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-lt/70 active:scale-[0.98]',
                  isActive
