...
export function ShareDropdown({
  ...
  const itemClass =
    'flex w-full items-center gap-3 px-4 py-2 text-sm text-white transition-colors hover:bg-white/10 focus-visible:outline-none focus-visible:bg-white/10 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-white/50'
