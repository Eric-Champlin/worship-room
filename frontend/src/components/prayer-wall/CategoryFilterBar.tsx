      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        >
          <button
            ...
            className={cn(
              'min-h-[44px] shrink-0 rounded-full border px-3 py-1.5 text-sm font-medium transition-colors duration-150 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-lt/70',
