  ...
  if (onClick) {
    return (
      <button
        ...
        className="min-h-[44px] rounded-full bg-white/[0.06] px-3 py-1 text-xs text-white/50 transition-[colors,transform] duration-fast hover:bg-white/10 hover:text-white/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-lt/70 active:scale-[0.98]"
