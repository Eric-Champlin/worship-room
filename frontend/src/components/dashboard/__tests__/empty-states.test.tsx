...
describe('Empty States — New User Dashboard', () => {
  ...
  it('mood chart "Check in now" CTA shows when onRequestCheckIn provided', () => {
    ...
    const faithPoints = {
      ...
      pointsToNextLevel: 100, todayActivities: { mood: false, pray: false, listen: false, prayerWall: false, readingPlan: false, gratitude: false, meditate: false, journal: false, reflection: false, challenge: false },
