    ...
    <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
      {ACTIONS.map(({ icon: Icon, label, to }) => (
        <Link
          key={label}
          to={to}
          className="flex flex-col items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 p-4 text-white/80 transition-all motion-reduce:transition-none hover:scale-[1.02] hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary motion-reduce:hover:scale-100 md:p-6"
        >
