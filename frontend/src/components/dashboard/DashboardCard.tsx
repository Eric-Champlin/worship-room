        ...
        <div className="flex items-center gap-2">
          ...
          {collapsible && (
            <button
              ...
              className="rounded-lg p-1 text-white/40 transition-colors hover:text-white/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
