...
export function ScriptureSessionCard({ reading, onPlay }: ScriptureSessionCardProps) {
  return (
    <button
      ...
      className="min-w-[220px] shrink-0 snap-start cursor-pointer rounded-xl border border-white/10 bg-gradient-to-br from-hero-mid/50 to-primary/10 p-4 text-left transition-colors hover:border-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-lt"
    >
