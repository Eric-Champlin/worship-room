...
export function BibleDrawer({ isOpen, onClose, ariaLabel, children }: BibleDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[${Z.DRAWER_BACKDROP}] bg-black/40`}
        onClick={onClose}
        aria-hidden="true"
      />
      ...
      <div
        ...
        className={cn(
          `fixed top-0 right-0 bottom-0 z-[${Z.DRAWER}] flex h-full flex-col overflow-hidden border-l border-white/10`,
