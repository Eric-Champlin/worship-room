      ...
      <FrostedCard as="article">
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full p-2 text-white/50 hover:bg-white/[0.06] hover:text-white/70 min-h-[44px] min-w-[44px]"
          >
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-primary hover:text-primary-lt"
        >
