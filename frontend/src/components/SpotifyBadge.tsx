...
export function SpotifyBadge() {
  return (
    ...
    >
      <svg
        viewBox="0 0 24 24"
        className="h-6 w-6 fill-spotify-green"
        aria-hidden="true"
      >
      ...
      <div className="flex flex-col leading-none">
        <span className="text-[9px] font-normal text-white/90">Listen on</span>
        <span className="mt-0.5 text-[17px] font-medium leading-tight text-white">Spotify</span>
      </div>
    </a>
  )
}
